...
const translations: Translations = {
  ...
  eldRegulatoryBullet3: { en: 'Enforced under 49 CFR Part 395', ru: 'Применяется в соответ��тви�� с 49 CFR Part 395', uz: '49 CFR Part 395 bo\'yicha amalga oshiriladi' },
  ...
  eldExemptionsBullet1: { en: 'Drivers using paper logs for no more than 8 days in 30-day period', ru: 'Водители, испол��зующ��е бумажные журналы не более 8 дней в течение 30-дневного периода', uz: '30 kunlik muddat ichida 8 kundan ortiq bo\'lmagan qog\'oz jurnallardan foydalanadigan haydovchilar' },
  ...
  telematicsTech: { en: 'Telematics & Technology Integration', ru: 'Т��лематика и технологическая интеграция', uz: 'Telematika va texnologik integratsiya' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative z-10 rounded-[40px] overflow-hidden shadow-2xl border-4 border-white">
              <img 
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-W9ERVbIaBlZZMCwLIPpsQSECiViwYP.png" 
                alt="Futuristic Digital Truck" 
